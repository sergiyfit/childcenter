<html lang="en"><head><meta charset="UTF-8"/><meta http-equiv="X-UA-Compatible" content="IE=edge"/><meta name="viewport" content="width=device-width, initial-scale=1.0"/><title>Центр розвитку дітей - Лабараторія маленьких винахідників Хмельницький</title><link rel="stylesheet" href="css/styles.css"/><link rel="preconnect" href="https://fonts.googleapis.com">
        ...
        <div class="header__menu__moving-part"> 
            ...
            <nav class="header__menu__container"> 
                <ul class="header__menu__elements flex">
                    ...
                    <main> 
                        <div class="main__art-page milk-background">
                            <h1 class="global__huge_text main__art-page_header-main">Дякуємо за запис! Протягом 12 годин вам зателефонує менеджер у робочий час.</h1>
<?php
try {
    ...
    $token = "7729145108:AAFojefXTywjGsjs2qGDAXjDd5cZNH2tg4k"; // Token, generated by Bot Father
...
</main><footer class="footer"> <div class="footer__contact milk-background"><div class="footer__contact_container flex"><div class="footer__contact_links"> <a class="icon-link icon-link--phone" href="tel:+380984562045">+38 098 456 20 45</a><a class="icon-link icon-link--email" href="mailto:labmalgen@gmail.com">labmalgen@gmail.com</a></div><div class="footer__contact_links-centered"> <div class="footer__contact_links-social"><a class="footer__contact_links-social-ref instagram" href="https://www.instagram.com/geniusesclub"></a><a class="footer__contact_links-social-ref facebook" href="https://www.facebook.com/geniusesclub15"></a></div><p class="footer__contact_links-copywright">&copy; Лабораторія маленьких геніїв 2015-2024. Усі права захищені</p></div><div class="footer__contact_links-left">       <div class="footer__contact_links__logo"> <a href="index.html"> <img src="img/header/Logo.svg" alt="Laboratory_malenkih_vihakhidnikiv_Khmalnytskiy"/></a></div><a class="footer__contact_links-left--politic" href="#">Політика конфіденційності</a></div></div></div></footer><div class="popup_background"><div class="popup"><div class="popup-dialog-close"></div><div class="mill-background"> Ви вже зробили запис, найближчим часом менеджер вам передзвонить </div></div></div><script src="js/scripts.js"> </script></body></html>